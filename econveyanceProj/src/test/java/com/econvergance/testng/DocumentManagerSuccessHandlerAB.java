...
public class DocumentManagerSuccessHandlerAB {
  ...
  private StringBuffer verificationErrors = new StringBuffer();
    ...
    driver.findElement(By.xpath("html/body/div[1]/div[2]/div[3]/div[4]/div/div[1]/table/tbody/tr[2]/td[1]/div/div/div[7]/table/tbody/tr[1]/td[1]/div")).click();
    ...
    driver.findElement(By.id("12815__cInvoiceNumber")).clear();
    driver.findElement(By.id("12815__cInvoiceNumber")).sendKeys("2413543432132");
    driver.findElement(By.id("12816__lcomp_date")).click();
