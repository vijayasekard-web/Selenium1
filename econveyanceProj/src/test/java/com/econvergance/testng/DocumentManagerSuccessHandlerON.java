...
public class DocumentManagerSuccessHandlerON {
  ...
  private StringBuffer verificationErrors = new StringBuffer();
   ...
   driver.findElement(By.xpath("html/body/div[4]/div[4]/form/div[5]/a[1]")).click();
    ...
    driver.findElement(By.id("25384__cInvoiceNumber")).clear();
    driver.findElement(By.id("25384__cInvoiceNumber")).sendKeys("2413543432132");
    driver.findElement(By.id("25385__lcomp_date")).click();
